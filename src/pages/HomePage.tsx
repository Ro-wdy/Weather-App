    ...
    <div className="bg-white">
      ...
      <div className="bg-purple-700">
        <div className="max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
          ...
          <Button
            onClick={() => onNavigate('subscribe')}
            className="mt-8 w-full sm:w-auto px-8 py-4 text-lg font-medium rounded-md text-purple-600 bg-white hover:text-white hover:bg-purple-50 shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-200"
          >
            Subscribe Now
          </Button>
        </div>
